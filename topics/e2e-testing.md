...
Which scenario of a story gets an E2E test — its happy path, and a scenario only a browser can observe — is set out in [Test Levels](testing-levels.md); this guide covers how the browser test itself is written.
